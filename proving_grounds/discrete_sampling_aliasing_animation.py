...
# WHAT THIS IS:
# Animation to simulate a discrete sampling of a 'continuous' signal at various sampling frequencies to show the effects of aliasing. Similar to the frequency ambiguity animation, this would work better as an interactive plot
