...
# WHAT THIS IS:
# Animation to show frequency ambiguity from discrete sampling. After making this, I realize this doesn't work very well as an animation. Next step would be to make an interactive plot via sliders.
