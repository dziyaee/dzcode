...
if __name__ == "__main__":
    ...
    n_tests = settings['Sweep2d']['Eval']['n_tests']
    precision_vs_torch = settings['Sweep2d']['Eval']['precisions']['vs_torch']
    precision_vs_scipy = settings['Sweep2d']['Eval']['precisions']['vs_scipy']
